                    ...
                    <div className={styles.container}>
                        <Link href="/">
                            ...
                            <Media query="(max-width: 736px)">
                                <img className={styles.logo} width={31.47} height={17.44} src={logotypeSmall.src} alt=""/>
                            </Media>
                        </Link>
                        {
                        ...
                        <div className={clsx(styles.links, "max-680px:!gap-[16px]")}>
                            <Image src={favorite} className="max-680px:!w-[20px] max-680px:!h-[20px]" alt="" width={24} height={24}/>
                            {isAuth ? (
                                <Image
