        ...
        >
          {dateRange[0] && dateRange[1] ? (
            ...
            >
              ...
              {
                isOpen ? <img className="max-1200px:w-[16px] max-1200px:-h-[16px]" src={calendarActive.src} alt="" /> :
                  <img className="max-1200px:w-[16px] max-1200px:-h-[16px]" src={img.src} alt="" />
              }
            </div>
          ) : (
            <div
              className={clsx(
                styles.date,
                isOpen && styles.focusDate,
                `max-1200px:!max-w-[100%] max-1200px:!min-h-[unset] max-1200px:!h-[unset] max-1200px:!p-[8px_12px] min-1200px:!max-w-[272px]`
              )}
            >
              <p className="text-[18px] leading-[23px] tracking-2% !font-semibold max-1200px:!text-[14px] max-1200px:!leading-[16.8px]">Дата
                начала аренды</p>
              {
                isOpen ? <img className="max-1200px:w-[16px] max-1200px:-h-[16px]" src={calendarActive.src} alt="" /> :
                  <img className="max-1200px:w-[16px] max-1200px:-h-[16px]" src={img.src} alt="" />
  ...
  return (
    <div className={clsx(styles.wrapper, compact ? styles.compact : "")}>
      ...
      <div
        className={clsx(
          styles.content,
          `!justify-start !pl-[46px] !pr-[54px] ${!compact
            ? "max-1200px:!p-[12px] max-1200px:gap-[6px] max-475px:px-12 min-1330px:!grid min-1330px:grid-cols-[288px_2px_272px_2px_341px_2px_54px] min-1330px:!gap-[30.41px] min-1200px:pt-[20px] min-1200px:pb-[17px]"
            : ""}`
        )}
      >
        {width < 1200 && !compact ? (
                  ...
                  >
                    {dateRange[0] && dateRange[1] ? (
                      ...
                      >
                        ...
                        {
                          isOpen ? <img src={calendarActive.src} className="w-[16px] h-[16px]" alt="" /> :
