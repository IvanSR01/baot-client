            ...
            {selected ? (
                ...
                >
                    <div>
                        ...
                        <p className={clsx(styles.selected, `capitalize text-[18px] ${selected || isOpen? "!text-[#18292D]" : "!text-[#728487]"} ${compact ? "font-bold" : "!font-semibold"} leading-[21.6px] !tracking-1% mt-[4px]  max-1200px:!text-[14px] max-1200px:!leading-[16.8px]`)}>{selected}</p>
                    </div>
                    {
                        img ? (isOpen ?
                ...
                >
                    <p className={`text-[16px] ${selected || isOpen? "!text-[#18292D]" : "!text-[#728487]"}  leading-[23px] ${compact ? "font-bold tracking-3%" : "!font-semibold tracking-2%"} max-1200px:!text-[14px] max-1200px:!leading-[16.8px]`}>{placeholder}</p>
                    {
                        img ? (isOpen ?
